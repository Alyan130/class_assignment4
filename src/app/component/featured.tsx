  ...
  return (
    <section className="bg-gray-200 py-[60px] flex items-center flex-col w-full"> 
      ...
      <div className="w-[100%] p-[15px] flex items-center justify-evenly flex-wrap gap-14 md:gap-8 py-[40px]">
        ...
        <div data-aos="zoom-in" className="w-[370px] p-[12px] bg-white flex flex-col items-center rounded-[10px]"> 
          <Image src={pic5} alt="pic2" className="w-[350px] h-[210px] rounded-[8px]" />
          <h3 className="text-[20px] font-bold mt-5"> &quot;Savoring the World: A Foodie’s Guide to Southeast Asia&quot;</h3>
          <p className="text-[16px] mt-4 leading-[26px]">If you believe that the best way to experience a culture is through its food, then this blog is for you. Southeast Asia is a melting pot of flavors,<b>...</b></p>
        ...
        <div data-aos="zoom-in" className="w-[370px] p-[12px] bg-white flex flex-col items-center rounded-[10px]"> 
          ...
          <h3 className="text-[20px] font-bold mt-5"> &quot;Island Escapes: Discovering Paradise in the Pacific&quot;</h3>
          <p className="text-[16px] mt-4 leading-[26px]">Picture a place where time slows down, the sun and the only sound you hear is the gentle lapping of waves against pristine shores <b>...</b></p>
        ...
        <div data-aos="zoom-in" className="w-[370px] p-[12px] bg-white flex flex-col items-center rounded-[10px]"> 
          ...
          <h3 className="text-[20px] font-bold mt-5"> &quot;Road Trippin’ USA: The Ultimate Cross-Country Adventure
&quot;</h3>
          <p className="text-[16px] mt-4 leading-[26px]">There’s a sense of freedom that only a road trip can bring, and nowhere is this more true than in the vast landscapes of the United States<b>...</b></p>
