...
export default function Header() {
  ...
  return (
    <header>
      ...
      {/* Mobile Menu
      {isMenuOpen && (
        <div className="md:hidden bg-slate-300 border-t-2 border-slate-400">
          <ul className="flex flex-col items-center gap-4 py-4">
            <li>
              <Link href={"/"} className="block py-2 px-4 text-black hover:bg-slate-400 transition duration-300 text-center">Home</Link>
            </li>
            <li>
              <Link href={"/blogs"} className="block py-2 px-4 text-black hover:bg-slate-400 transition duration-300 text-center">Blogs</Link>
            </li>
            <li>
              <Link href={"/contact"} className="block py-2 px-4 text-black hover:bg-slate-400 transition duration-300 text-center">Contact</Link>
            </li>
          </ul>
        </div>
      )} */}
